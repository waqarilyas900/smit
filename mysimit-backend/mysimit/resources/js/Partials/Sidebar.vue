<template>
    <div class="sidebar shadow-md" :class="{ collapsed: collapsed }">
        ...
        <img src="../../../public/images/logo/new-logo.png" style="width: 150px;" />
        <!-- <div class="ml-4 flex-grow" :class="{ 'lg:hidden': collapsed }">
            <span class="text-lg font-bold leading-3">My-Simit</span>
        ...
        ">
            ...
            <!-- Coupons -->
            <sidebar-item :href="route('coupons.index')" :active="isActive(['coupons.*'])" :collapsed="collapsed">
                <template #icon><i class="ti-map-alt" title="Coupons"></i></template>
                Coupon
            </sidebar-item>
