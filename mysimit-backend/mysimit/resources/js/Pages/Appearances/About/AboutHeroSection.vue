    ...
    <div class="">
        <form @submit.prevent="save">
            ...
            <form-group class="border-b">
                ...
                <div class="w-full mt-1">
                    <jet-image-input :url="$page.props.aboutPageHero?.primaryMediaUrl" v-model="form.poster"></jet-image-input><p class="desc">Image size must be (1920×788)</p>
...
export default {
    ...
    data() {
        return {
            ...
            // }),
            form: this.$inertia.form({
                en:{title: this.$page.props.aboutPageHero?.data?.en?.title},
                ar:{title: this.$page.props.aboutPageHero?.data?.ar?.title},
                poster: null,
            }),
        };
    },
