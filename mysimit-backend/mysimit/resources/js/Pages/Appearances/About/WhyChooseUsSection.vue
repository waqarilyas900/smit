            ...
            <table v-if="$page.props.whyChooseUs.length">
                ...
                <tbody>
                    <tr v-for="(row, index) in $page.props.whyChooseUs" :key="index">
                        ...
                        <td>{{row.title?.en}}</td>
                        <td class="truncate" style="max-width:100px">{{row.description?.en}}</td>
        ...
        <jet-dialog-modal :show="showDialog" @close="closeModal">
            ...
            <template #content>
                ...
                <form-group class="border-b">
                    <jet-label class="md:w-1/4 mt-2" for="title" value="Title (en)" required />
                ...
                <!-- title -->
                <form-group class="border-b">
                    <jet-label class="md:w-1/4 mt-2" for="title" value="Title (ar)" required />
                    <div class="w-full mt-1">
                ...
                <form-group class="border-b">
                    ...
                    <div class="w-full mt-1">
                        <jet-text-input v-model="form.description.en" id="description" type="text" class="mt-1 block w-full" autocomplete="value" />
                 ...
                 <form-group class="border-b">
                    ...
                    <div class="w-full mt-1">
                        <jet-text-input v-model="form.description.ar" id="description" type="text" class="mt-1 block w-full" autocomplete="value" />
                        <jet-input-error class="mt-2" />
                    </div>
                </form-group>
...
export default {
    ...
    methods: {
        ...
        editWhyChooseUs(index) {
            ...
            this.form.title = { en: this.$page.props.whyChooseUs[index].title?.en, ar: this.$page.props.whyChooseUs[index].title?.ar };
            this.form.description = { en: this.$page.props.whyChooseUs[index].description?.en, ar: this.$page.props.whyChooseUs[index].description?.ar } ;
            this.form.iconUrl = this.$page.props.whyChooseUs[index].primaryMediaUrl;
        },
    },
};
</script>
