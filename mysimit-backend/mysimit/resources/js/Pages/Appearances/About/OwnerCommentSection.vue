<template>
    <div class="">
        <form @submit.prevent="save">
            ...
            <!-- Subtitle-->
            <form-group class="border-b">
                <jet-label class="md:w-1/4 mt-2" for="subtitle" value="Subtitle (en)" required />
                <div class="w-full mt-1">
                    <jet-input v-model="form.en.subtitle" id="subtitle" type="text" class="w-full" autocomplete="subtitle" />
            ...
            <!-- Subtitle-->
            <form-group class="border-b">
                <jet-label class="md:w-1/4 mt-2" for="subtitle" value="Subtitle (ar)" required />
                <div class="w-full mt-1">
                    <jet-input v-model="form.ar.subtitle" id="subtitle" type="text" class="w-full" autocomplete="subtitle" />
                    <jet-input-error :message="form.errors.subtitle" class="mt-2" />
                </div>
            </form-group>
             ...
             <!-- Description -->
            <form-group class="border-b">
                <jet-label class="md:w-1/4 mt-2" for="value" value="Description (en)" required />
                <div class="w-full mt-1">
                    <jet-text-input v-model="form.en.description" id="description" type="text" class="mt-1 block w-full" autocomplete="value" />
            ...
            <!-- Description -->
            <form-group class="border-b">
                <jet-label class="md:w-1/4 mt-2" for="value" value="Description (ar)" required />
                <div class="w-full mt-1">
                    <jet-text-input v-model="form.ar.description" id="description" type="text" class="mt-1 block w-full" autocomplete="value" />
                    <jet-input-error class="mt-2" />
                </div>
            </form-group>
...
export default {
    ...
    data() {
        return {
            ...
            // }),
            form: this.$inertia.form({
                en:{title: this.$page.props.ownerComment?.data?.en?.title, subtitle: this.$page.props.ownerComment?.data?.en?.subtitle, description: this.$page.props.ownerComment?.data?.en?.description},
                ar:{title: this.$page.props.ownerComment?.data?.ar?.title, subtitle: this.$page.props.ownerComment?.data?.ar?.subtitle, description: this.$page.props.ownerComment?.data?.ar?.description},
                image: null,
            }),
        };
    },
