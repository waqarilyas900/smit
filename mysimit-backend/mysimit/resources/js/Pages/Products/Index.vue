						...
						<tr v-for="(row, index) in rows" :key="index">
							...
							<td>
								<div class="flex">
									...
									<div>
										<p class="text-sm text-gray-500">{{row.category.name?.en}}</p>
										<!-- <p>(AR) {{row.name.ar}}</p> -->
                                        <p>{{row.name?.en}}</p>
									</div>
								</div>
							...
							<td>
								<label class="toggle">
									<input type="checkbox" class="togglecheck"  @click="changeStatus(route('products.published', row.id))" :checked="row.status == 'published'">
