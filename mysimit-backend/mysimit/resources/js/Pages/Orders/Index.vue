        ...
        <datatable :data="orders" searchRoute="orders.index" :filters="filters">
            ...
            <template #right-header>
                ...
                <filter-dropdown v-model="filters" @reset="reset">
                    ...
                    <jet-label class="my-2 px-2 font-semibold" for="from" value="From Date" />
                    <input v-model="filters.from" id="from" type="date" class="px-4 border-gray-300 focus:border-primary-300 focus:ring focus:ring-primary-200 focus:ring-opacity-50 rounded-full shadow-sm w-full" autocomplete="date" />
                    <!-- <searchable-select :options="customers" v-model="filters.customer" autoFocus></searchable-select> -->

                    <jet-label class="my-2 px-2 font-semibold" for="to" value="To Date" />
                    <input v-model="filters.to" id="to" type="date" class="px-4 border-gray-300 focus:border-primary-300 focus:ring focus:ring-primary-200 focus:ring-opacity-50 rounded-full shadow-sm w-full" autocomplete="date" />
                    <!-- <searchable-select :options="customers" v-model="filters.customer" autoFocus></searchable-select> -->
                    ...
                    <tbody>
                        <tr v-for="(row, index) in rows" :key="index">
                            ...
                            <td>
                                ...
                                <p class="text-xs">
                                    <span>Ordered At: {{ row.orderDateFormatted }}</span>
                                </p>
                                <p class="text-sm"></p>
                            </td>
