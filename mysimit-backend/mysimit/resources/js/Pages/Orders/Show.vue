	...
	<detail-view title="Order Details" :breadcrumb="breadcrumb">
		...
		<tabs :options="{ useUrlFragment: false }">
			<tab name="Order Details">
				...
				<!-- Delivery Date -->
				<detail-section class="border-b" label="Delivery" :value="order.delivery"></detail-section>

				<!-- Customer Number -->
				<detail-section class="border-b" label="Customer Number" :value="order.customer.phone"></detail-section>
			...
			<tab name="Address">
				...
				<!-- Type -->
				<detail-section class="border-b" label="Type">
					<p class="text-90" v-if="order.type">{{ order.type }}</p>
					<p v-else>-</p>
				</detail-section>
				
				<!-- street -->
				<detail-section class="border-b" label="Street">
					<p class="text-90" v-if="order.billingAddress">{{ order.billingAddress.street }}</p>
					<p v-else>-</p>
				</detail-section>

				<!-- city -->
				<!-- <detail-section class="border-b" label="City">
					<p class="text-90" v-if="order.billingAddress">{{ order.billingAddress.city }}</p>
					<p v-else>-</p>
				</detail-section> -->

				<!-- state -->
				<detail-section class="border-b" label="State">
					<p class="text-90" v-if="order.billingAddress">{{ order.billingAddress.state }}</p>
					<p v-else>-</p>
				</detail-section>

				<!-- country -->
				<detail-section class="border-b" label="Country">
					<p class="text-90" v-if="order.billingAddress">{{ order.billingAddress.country }}</p>
					<p v-else>-</p>
				</detail-section>

				<!-- house -->
				<detail-section class="border-b" label="House">
					<p class="text-90" v-if="order.billingAddress">{{ order.billingAddress.house }}</p>
					<p v-else>-</p>
				</detail-section>

				<!-- block -->
				<detail-section class="border-b" label="Block">
					<p class="text-90" v-if="order.billingAddress">{{ order.billingAddress.block }}</p>
					<p v-else>-</p>
				</detail-section>

				<!-- avenue -->
				<detail-section class="border-b" label="Avenue">
					<p class="text-90" v-if="order.billingAddress">{{ order.billingAddress.avenue }}</p>
					<p v-else>-</p>
				</detail-section>

				<!-- apartment -->
				<detail-section class="border-b" label="Apartment">
					<p class="text-90" v-if="order.billingAddress">{{ order.billingAddress.apartment }}</p>
					<p v-else>-</p>
				</detail-section>
