...
Route::middleware(['auth'])->group(function () {
    ...
    Route::get('/status_update/{id}', [ZoneController::class, 'status_update'])->name('status.update');
    ...
    // Route::post('coupons.store', [CouponController::class, 'index'])->name('coupons.index');
    //Coupons End

    // Product Route
    Route::resource('products', ProductController::class);
    Route::get('/products/{product}/published', [ProductController::class, 'published'])->name('products.published');
    Route::post('/products/{product}/isFeatured', [ProductController::class, 'isFeatured'])->name('products.isFeatured');

    // Addon
    Route::post('/product/{product}/addon/create', [AddonController::class, 'store'])->name('addon.store');
    Route::post('/addon/{addon}/edit', [AddonController::class, 'edit'])->name('addon.edit');
    Route::delete('/addon/{addon}', [AddonController::class, 'destroy'])->name('addon.destroy');

    // Addon-Option
    Route::post('/addon/{addon}/option/create', [OptionController::class, 'store'])->name('option.store');
    Route::post('option/{option}/edit', [OptionController::class, 'edit'])->name('option.edit');
    ...
    Route::post('/settings/storetme', [SettingsController::class, 'storetime'])->name('settings.storetime');
