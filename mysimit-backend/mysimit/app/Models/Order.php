...
class Order extends Model implements HasMedia
{
    ...
    protected $dates = ['rider_assign_date', 'delivery_date', 'created_at', 'updated_at'];
    ...
    protected $appends = ['subTotalFormatted', 'grandTotalFormatted','totalDiscountFormatted', 'assignDateFormatted', 'orderDateFormatted'];
