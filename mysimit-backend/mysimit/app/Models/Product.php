...
{
    use InteractsWithMedia, Favoriteable, ReviewRateableTrait, HasTranslations;
     ...
     * @var array
     */
    protected $appends = ['mediaCollection', 'thumbnailMedia', 'thumbnailMediaUrl', 'actualPriceFormatted',  'salePriceFormatted', 'averageRatings', 'rawTrans'];
    ...
    public function getRawTransAttribute()
    {
