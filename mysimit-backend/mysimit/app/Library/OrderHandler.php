...
class OrderHandler
{
    ...
    public function createOrder($request)
    {
        ...
        $order = Order::create([
            ...
            'delivery'           => $request->deliveryCharges,
            'type'           => $request->type,
        ]);
        //$order->roles()->customer($customerId);
        ...
        if (!empty($request->billingAddress)) {
            $order->address()->create(
                [
                    ...
                    'house'     => $request->billingAddress['house'],
                    'block'     => $request->billingAddress['block'],
                    'avenue'    => $request->billingAddress['avenue'],
