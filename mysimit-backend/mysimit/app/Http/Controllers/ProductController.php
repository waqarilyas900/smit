...
class ProductController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return Inertia::render('Products/Index', [
            'products' => Product::with(['category', 'tags', 'unit', 'addons'])
                ->filter($request->all())
                ->sorted()
                ->paginate()
                ->withQueryString(),
    ...
    public function store(ProductRequest $request)
    {
        ...
        DB::transaction(function () use ($request) {
            $product = Product::create($request->only('categoryId', 'name', 'description', 'actualPrice', 'discount', 'discount_type', 'unitId'));
    ...
    public function show(Product $product)
    {
        ...
        return Inertia::render('Products/Show', [
            'product' => $product->load('tags', 'unit', 'category'),
            'tags' => Tag::orderBy('name')->pluck('name')->toArray(),
            'units' => Unit::orderBy('name')->get(),
    ...
    public function update(ProductRequest $request, Product $product)
    {
        ...
        DB::transaction(function () use ($request, $product) {
            ...
            $product->update($request->only('categoryId', 'name', 'description', 'actualPrice', 'discount', 'discount_type', 'unitId'));
