...
class ZoneController extends Controller
{
    ...
    public function store(ZoneRequest $request)
    {
        ...
        // Start from here ...
        Zone::create($request->only('name', 'city', 'state', 'country', 'price', 'mini_order'));
    ...
    public function update(ZoneRequest $request, Zone $zone)
    {
        ...
        // Start from here ...
        $zone->update($request->only('name', 'city', 'state', 'country', 'price', 'mini_order', 'status'));
