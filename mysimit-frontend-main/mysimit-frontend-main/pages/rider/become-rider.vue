  ...
  <div>
    ...
    <the-banner v-if="getRiderHeroSection && getRiderHeroSection.data" :bannerLink="getRiderHeroSection.primaryMediaUrl">
      ...
      <template #breadcrumbs>
        <div>
          <h6 class="font-extralight text-lg md:text-2xl text-white">{{getRiderHeroSection.data.subtitle}}</h6>
    ...
    <div class="container">
      ...
      <div class="text-center mb-8 md:mb-16">
        ...
        <h6 class="font-semibold text-xl mt-5">Already a Sabziwalay rider?</h6>
