<template>
  <div>
    ...
    <loading :loading="isLoading">
      ...
      <div class="sm:flex justify-between items-start">
        ...
        <div>
          <div class="flex items-center">
            <h6 class="font-semibold text-lg">Invoice: {{order.invoiceNo}}</h6>
            <the-badge class="ml-3" :value="order.status"></the-badge>
          </div>
          <h5 class="font-normal text-sm">{{order.dateFormatted}}</h5>
          <!-- payment method -->
          <div>
            <h6 class="font-normal text-md mt-3 mb-5">Payment method:
        ...
        <div v-if="order && order.customer " class="sm:text-right">
          ...
          <h5 v-if="order.customer.phone"> {{order.customer.phone}}</h5>
          <div>
      ...
      <!-- order items -->
      <h6 class="font-semibold text-lg mt-10 mb-3">Order Items</h6>
