<template>
  <div>
    <h2 class="font-semibold text-xl hidden">Customer Reviews</h2>

    <!-- rating -->
    <div class="rating flex items-center text-sm mt-3 pb-8 hidden">
      <!-- rating component -->
      <client-only>
      ...
      <div class="ml-5 w-full">
        <div class="sm:flex justify-between items-center">
          <div>
            ...
            <!-- rating -->
            <div class="rating flex items-center text-yellow-500 text-sm hidden">
              <!-- rating component -->
              <client-only>
